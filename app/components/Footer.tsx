      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-slate-300 text-sm">
              Empowering Businesses & Students with Technology. We provide innovative IT solutions and real-world internship opportunities.
            </p>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/internships" className="text-slate-300 hover:text-white transition-colors">
                  Internship Programs
                </Link>
              </li>
              <li>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2 text-sm">
              <p className="flex items-center space-x-2">
                ...
                <span className="text-slate-300">123 Tech Street, City, State 12345</span>
              </p>
              <p className="flex items-center space-x-2">
                <svg className="w-4 h-4 text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <p className="flex items-center space-x-2">
                ...
                <span className="text-slate-300">info@virtunex.com</span>
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center">
          <p className="text-gray-400 text-sm">
            © 2024 Virtunex Tech Solution. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
